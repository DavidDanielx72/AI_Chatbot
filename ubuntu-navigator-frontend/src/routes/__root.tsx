...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Ubuntu Navigator" },
      { property: "og:site_name", content: "Ubuntu Navigator" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@graph": [
            {
              "@type": "Organization",
              name: "Ubuntu Navigator",
              url: "https://cape-town-aid-guide.lovable.app",
              description:
                "Free AI helper for people in Cape Town, South Africa, to access SASSA grants, Home Affairs IDs, SARS registration, and basic labour rights.",
